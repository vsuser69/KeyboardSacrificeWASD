...
True Type Font: Basic Sans Serif 7 version 1.0


EULA
-==-
The font Basic Sans Serif 7 is freeware for home using only.
...
Files in basic_sans_serif_7.zip:
       	readme.txt     				this file;
        basic_sans_serif_7.ttf 			regular font;
	basic_sans_serif_7_screen.png		preview image.
